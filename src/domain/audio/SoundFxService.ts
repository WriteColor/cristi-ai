/**
 * Cristi Desktop - Procedural Cybernetic Sound FX Synthesizer (TypeScript)
...
export class SoundFxService {
  ...
  public playConnectedBleep(): void {
    this.playConnect();
  }
  ...
  /** Boss key stealth mute feedback */
  public playBossKey(): void {
    this.playDisconnect();
  }
